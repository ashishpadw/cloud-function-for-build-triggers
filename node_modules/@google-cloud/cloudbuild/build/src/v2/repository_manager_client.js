...
class RepositoryManagerClient {
    ...
    fetchReadWriteToken(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                repository: (_a = request.repository) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    updateConnection(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'connection.name': (_a = request.connection.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    fetchLinkableRepositories(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                connection: (_a = request.connection) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
